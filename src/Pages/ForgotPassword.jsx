...
function ForgotPassword() {
  ...
  return (
    <section>
      <h1 className="text-center text-3xl mt-6  font-bold font-serif">
      ForgotPassword
      </h1>
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form onSubmit={submithandler}>
            ...
            <div className="flex justify-between  sm:text-lg whitespace-nowrap">
              <p className="mb-6">Don't Have an Account? <Link to={"/SignUp"} className="text-red-600 hover:text-red-800  transition 
              duration-2000 ease-in-out ml-2">Register</Link></p>
              <p ><Link to={"/SignIn"} className="text-blue-600 hover:text-blue-800  transition duration-2000 ease-in-out">
                Sign in instead</Link></p>
            </div>
            <div>
